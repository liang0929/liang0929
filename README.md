...
| [**esp32-obd2-dashboard**](https://github.com/liang0929/esp32-obd2-dashboard) | ESP32-S3 車用 OBD2/CAN 即時儀表板：4.3 吋觸控、街道/賽道/診斷模式、CAN sniffer——賽車數據記錄器第一代實作（ESP-IDF），含 3D 列印外殼 |
| [**local-voice-control**](https://github.com/liang0929/local-voice-control) | 全本地語音助理：openWakeWord 喚醒 + Silero VAD + FunASR 語音辨識 + Ollama LLM function calling → Matter 智慧插座控制，零雲端依賴 |
| [**Dynamic_Blind_Spot_Shield**](https://github.com/liang0929/Dynamic_Blind_Spot_Shield) | Arduino 動態盲點防護裝置：超音波感測 + servo/步進馬達控制與警報（PlatformIO） |
